...
<tr>
    ...
    <tr>
       <td class="data"><%= result.getNo() %></td>
       <td class="data"><%= result.getTitle() %></td>
       <td class="data"><%= result.getContent() %></td>
       <td class="data"><%= result.getWriter() %></td>
    </tr>
