...
<body>
	...
	<div class="outer outer-member-insert container mt-4">
		...
		<!-- 회원 가입 폼 -->
		<form id="joinForm"
			action="${pageContext.servletContext.contextPath}/member/insert"
			method="post" class="needs-validation" novalidate>
			<div class="row mb-3">
				<label for="memberId" class="col-sm-2 col-form-label">* 아이디</label>
				<div class="col-sm-7">
					<input type="text" class="form-control" maxlength="10" name="id"
						id="memberId" required>
				</div>
				<div class="col-sm-3">
					<button type="button" class="btn btn-outline-primary"
						id="duplicationCheck">중복확인</button>
				</div>
			</div>
			<div class="row mb-3">
			...
			<div class="text-center">
				<button type="reset" class="btn btn-secondary" id="goMain">메인으로</button>
